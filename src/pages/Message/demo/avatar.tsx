...
const star = require('@/assets/icons/smile.png');
...
export const examples = [
  {
    ...
    label: 'ES',
    size: pt(47),
    badgeProps: {backgroundColor: onlineColor},
    source: {
  ...
  },
  {
    ...
    source: {
      uri: 'https://www.gravatar.com/avatar/00000000000000000000000000000000?d=404',
    },
    onImageLoadStart: () =>
      console.log('AvatarScreen: Invalid avatar load STARTED...'), // eslint-disable-line
    onImageLoadEnd: () =>
      console.log('AvatarScreen: Invalid avatar load ENDED'), // eslint-disable-line
    onImageLoadError: () =>
      console.log('AvatarScreen: Invalid avatar load FAILED'), // eslint-disable-line
  },
  {
    ...
    source: {
      uri: 'https://static.altomusic.com/media/catalog/product/M/A/MAJ100SBK_0.jpg',
    },
    onImageLoadStart: () =>
      console.log('AvatarScreen: Monitored avatar load STARTED...'), // eslint-disable-line
    onImageLoadEnd: () =>
      console.log('AvatarScreen: Monitored avatar load ENDED'), // eslint-disable-line
  },
  {
      ...
      <ScrollView contentContainerStyle={styles.container}>
        {_.map(examples, (example, i) => (
          <View key={i} style={styles.section}>
            <Text $textDefault style={{...Typography.text80}}>
              {example.title}
            </Text>
            <Avatar
