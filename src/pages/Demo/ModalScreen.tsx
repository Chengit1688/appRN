        ...
        <Carousel
          ...
          <View bg-green50 flex style={styles.page}>
            ...
            <View padding-20>
              ...
              <Text text70>
                By default you get the &apos;x&apos; cancel icon and
                &apos;save&apos; as done label
              </Text>
            </View>
          </View>
          ...
          <View bg-orange70 flex style={styles.page}>
            ...
            <View padding-20>
              <Text text70>
                Sending onDone/onCancel is required for rendering done/cancel
                actions
              </Text>
            </View>
          </View>
          ...
          <View bg-grey70 flex style={styles.page}>
            ...
            <View padding-20>
              <Text text70>
                use doneButtonProps/cancelButtonProps properties to have custom
                behaviour or style for done/cancel actions
              </Text>
            </View>
          </View>
          ...
          <View bg-yellow80 flex style={styles.page}>
              ...
              rightButtons={[
                {
                  label: 'save',
                  buttonProps: {
                    labelStyle: {color: Colors.yellow10, marginRight: 14},
                  },
            ...
            <View padding-20>
              <Text text70>
                This is an example for using the rightButtons and leftButtons
                props for having more than one button each side
              </Text>
            </View>
          </View>
        </Carousel>
