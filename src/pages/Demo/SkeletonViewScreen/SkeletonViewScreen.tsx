...
export default class SkeletonViewScreen extends Component {
  ...
  renderTopSection = () => {
    ...
    return (
      <View marginH-page marginV-s1>
        ...
        {ExampleScreenPresenter.renderRadioGroup.call(
          this,
          'Data type',
          'dataType',
          DATA_TYPE,
          ...
          return (
            <ListItem
              ...
              <ListItem.Part
                middle
                column
                containerStyle={[styles.border, {marginLeft: 18}]}>
  ...
  getImageSize = () =>
    (Constants.screenWidth - IMAGE_URIS.length * Spacings.s5) /
    IMAGE_URIS.length;
  ...
  renderText = () => {
    return (
      <Text>
        I want to sell my goods internationally and found Wix Web Services can
        be used for shipping-centric implementations.
      </Text>
    );
  };
      ...
      <View margin-20>
        <View row spread marginB-8>
          ...
          <SkeletonView
            ...
            showContent={isDataAvailable}
            renderContent={() => (
              <Button label={'Info'} size={Button.sizes.small} link />
            )}
          />
        </View>
        <SkeletonView
          ...
          showContent={isDataAvailable}
          renderContent={() => (
            <Text>Lorem Ipsum is simply dummy text of the industry.</Text>
          )}
