...
import cameraSelected from '@/assets/icons/chat/toolbar/camera.png';
import video from '@/assets/icons/chat/toolbar/emoji.png';
import tags from '@/assets/icons/chat/toolbar/more.png';
import collections from '@/assets/icons/chat/toolbar/photo.png';
import richText from '@/assets/icons/chat/toolbar/red_packet.png';
      ...
      <View flex bg-$backgroundNeutralLight>
        ...
        <Carousel
          ...
          <View style={styles.page}>
            <ActionBar
              ...
              actions={[
                ...
                {
                  label: 'Add Discount',
                  onPress: () => Alert.alert('add discount'),
                  $textDefaultLight: true,
                },
                {
                  label: 'Duplicate',
          ...
          <View style={styles.page}>
            <ActionBar
              actions={[
                {label: 'Delete', $textDangerLight: true},
                {label: 'Edit'},
              ]}
            />
          </View>
            ...
            <ActionBar
              ...
              actions={[
                ...
                },
                {
                  label: 'Italic',
                  text60: true,
                  labelStyle: {fontStyle: 'italic', color: Colors.$textDefault},
                },
                {
                  label: 'Link',
                  text60: true,
