...
const localImageSource = require('@/assets/imgs/empty.png');
const remoteImageSource = {
  uri: 'https://cdn.pixabay.com/photo/2017/04/19/20/10/morning-2243465_1280.jpg',
};
      ...
      <View>
        <ScrollView
          ...
          <View style={styles.pageView}>
            <StateScreen
              title={'Oppsie (with local image)1'}
          ...
          <View style={styles.pageView}>
            <StateScreen
              title={'Oppsie (with remote image)2'}
              subtitle={'Nothing to see here..'}
              ctaLabel={'OK'}
          ...
          <View style={styles.pageView}>
            <StateScreen
              title={'Oppsie (with local image)3'}
              subtitle={'Nothing to see here..'}
              ctaLabel={'OK'}
              imageSource={localImageSource}
            />
          ...
          <View style={styles.pageView}>
            <StateScreen
              title={'Oppsie (with remote image)4'}
              subtitle={'Nothing to see here..'}
              ctaLabel={'OK'}
              imageSource={remoteImageSource}
            />
