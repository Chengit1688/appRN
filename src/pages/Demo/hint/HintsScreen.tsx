...
const settingsIcon = require('@/assets/icons/search.png');
const reactions = ['❤️', '😮', '😔', '😂', '😡'];
...
export default class HintsScreen extends Component<HintScreenProps> {
    ...
    return (
      <View absR absB padding-page style={{zIndex: 10}}>
        <Incubator.ExpandableOverlay
          ...
          <Button round iconSource={Assets.icons.search} $backgroundDefault />
        </Incubator.ExpandableOverlay>
      </View>
    );
  }
  ...
  render() {
    ...
    const color =
      !showCustomContent && showReactionStrip
      ...
      <View flex>
        <View
          ...
          <Hint
            ...
            // offset={35}
            position={
              showBottomHint ? Hint.positions.BOTTOM : Hint.positions.TOP
            }
            ...
            // edgeMargins={30}
            onBackgroundPress={
              useBackdrop && !useTargetFrame ? this.toggleHint : undefined
            }
