...
import {joinTeam, getTeamMemeberInfo} from '@/api/shopping';
import * as toast from '@/utils/toast';
import _ from 'lodash';
import {useRoute} from '@react-navigation/native';
import {shallowEqual, useSelector} from 'react-redux';

export default function FrandchiseeIndex(props: any) {
    ...
    if (params?.source && params?.source === 'qrcode') {
      ...
      getTeamMemeberInfo({
        ...
        if (res.role === 0 && res.shop_status === 0) {
          ...
          navigation.replace('franchiseeDetail', {shop_id: res.shop_id});
        }
      });
    }
  }, [params]);
    ...
    <View
      ...
      <View
        ...
        <FullButton
          text={t('成为加盟商')}
          onPress={() => {
            navigation.navigate({name: 'applyJoin'});
          }}></FullButton>
      </View>
      <Popup
        visible={joinVisible}
